# contexto/ — o que Adriana Bessa sabe/precisa lembrar sobre a Grupo VAB

Pasta pessoal de contexto. Aqui Adriana Bessa acumula o conhecimento que ele precisa ter à mão pra operar no dia a dia:
...
2. Via edição manual — Adriana Bessa pode editar à mão quando quiser

## Formato

- **Markdown** ou **HTML** apenas
- Nomes livres — não há convenção rígida aqui (é pessoal)
- Sugestões: `pendencias.md`, `decisoes.md`, `projetos.md`, `pessoas.md`, `produtos.md`, etc. Adaptar ao que faz sentido pra Adriana Bessa.
...
- Daily notes (ficam em `agentes/ada/memory/`)
